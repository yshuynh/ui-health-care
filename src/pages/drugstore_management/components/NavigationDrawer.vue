  ...
  <v-card class="elevation-1">
    ...
    >
      <v-list-item class="px-2">
        <v-list-item-avatar>
          <v-img :src="$store.state.drugstore.background"></v-img>
        </v-list-item-avatar>

        <v-list-item-title>{{$store.state.drugstore.name}}</v-list-item-title>
  ...
  data() {
    return {
      items: [
        ...
        {title: this.$t('pharmacistList'), icon: 'mdi-medical-bag', to:'pharmacist_list'},
      ],
    }
  },
  computed: {
