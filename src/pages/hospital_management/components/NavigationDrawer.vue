  ...
  <v-card class="elevation-1">
    ...
    >
      <v-list-item class="px-2">
        <v-list-item-avatar>
          <v-img :src="$store.state.hospital.background"></v-img>
        </v-list-item-avatar>

        <v-list-item-title>{{$store.state.hospital.name}}</v-list-item-title>
  ...
  data() {
    return {
      items: [
        ...
        {title: this.$t('doctorList'), icon: 'mdi-medical-bag', to:'doctor_list'},
      ],
    }
  },
  computed: {
