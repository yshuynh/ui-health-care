...
<!--                <v-text-field :label="this.$t('admin')" v-model="admin.name"-->
<!--                              :rules="rules.required"-->
<!--                              name="name"-->
<!--                ></v-text-field>-->
<!--              </v-col>-->
              <v-col cols="12" md="4" sm="12" class="py-0">
                <v-text-field :label="this.$t('phoneNumber')" v-model="admin.user.phone_number" disabled
                ></v-text-field>
              </v-col>
<!--              <v-col cols="12" md="12" sm="12" class="py-0">-->
<!--                <v-textarea :label="this.$t('address')" v-model="admin.address"-->
<!--                            :rules="rules.required"-->
<!--                            name="name"-->
<!--                            auto-grow-->
<!--                            rows="1"-->
...
<!--    <v-card v-html="getGgMapIframe(admin.address)">-->
<!--    </v-card>-->
...
export default {
  ...
  mounted() {
    this.admin = Object.assign({}, this.$store.state.admin);
  },
  watch: {
        ...
        adminService.updateAdminInfo(data)
            .then(response => {
              if (response.status === 200) {
                ...
                this.$store.commit('SET_ADMIN', response.data);
