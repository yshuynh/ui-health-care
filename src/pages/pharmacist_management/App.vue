<template>
  <v-app v-resize="onResize">
    ...
    <NavigationDrawer :isShowNav.sync="showNavDrawer"/>
...
import NavigationDrawer from "@/pages/pharmacist_management/components/NavigationDrawer";
...
export default {
  ...
  mounted() {
    pharmacistService.getPharmacistInfo()
        .then(response => {
